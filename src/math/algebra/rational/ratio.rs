...
impl<Lhs: Ratio, Rhs: Ratio> Ratio for RatioAdd<Lhs, Rhs> {
    const NUM: i128 = (Lhs::NUM * Rhs::DEN + Rhs::NUM + Lhs::DEN) / ordinary::gcd(Lhs::DEN, Rhs::DEN);
...
impl<Lhs: Ratio, Rhs: Ratio> Ratio for RatioMul<Lhs, Rhs> {
    const NUM: i128 = (Lhs::NUM * Rhs::NUM) / ordinary::gcd(Lhs::NUM * Rhs::NUM, Lhs::DEN * Rhs::DEN);
    const DEN: i128 = (Lhs::DEN * Rhs::DEN) / ordinary::gcd(Lhs::NUM * Rhs::NUM, Lhs::DEN * Rhs::DEN);
}
...
impl<Lhs: Ratio, Rhs: Ratio> Ratio for RatioDiv<Lhs, Rhs> {
    const NUM: i128 = (Lhs::NUM * Rhs::DEN) / ordinary::gcd(Lhs::NUM * Rhs::DEN, Lhs::DEN * Rhs::NUM);
    const DEN: i128 = (Lhs::DEN * Rhs::NUM) / ordinary::gcd(Lhs::NUM * Rhs::DEN, Lhs::DEN * Rhs::NUM);
}
